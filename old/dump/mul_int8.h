WARNING: Cannot find schema for: registers.xml - skipping validation
0 1 0
0 1 0
0 1 0
0 a 0
WARNING: target 0x0 doesn't match register's domain 0x100
EMIT(REG_PC_VERSION, 0x0);
WARNING: target 0x0 doesn't match register's domain 0x100
EMIT(REG_PC_VERSION, 0x0);
WARNING: target 0x0 doesn't match register's domain 0x100
EMIT(REG_PC_VERSION, 0x0);
...
EMIT(REG_DPU_DATA_FORMAT, 0x0);
EMIT(REG_DPU_OFFSET_PEND, 0x0);
EMIT(REG_DPU_DST_BASE_ADDR, 0xffff10c0);
...
EMIT(REG_DPU_DATA_CUBE_NOTCH_ADDR, 0x0);
EMIT(REG_DPU_DATA_CUBE_CHANNEL, DPU_DATA_CUBE_CHANNEL_ORIG_CHANNEL(15) | DPU_DATA_CUBE_CHANNEL_CHANNEL(15));
...
EMIT(REG_DPU_RDMA_RDMA_DATA_CUBE_CHANNEL, DPU_RDMA_RDMA_DATA_CUBE_CHANNEL_CHANNEL(15));
EMIT(REG_DPU_RDMA_RDMA_SRC_BASE_ADDR, 0xffff1000);
EMIT(REG_DPU_RDMA_RDMA_BRDMA_CFG, 0x0);
EMIT(REG_DPU_RDMA_RDMA_BS_BASE_ADDR, 0x0);
EMIT(REG_DPU_RDMA_RDMA_NRDMA_CFG, 0x0);
EMIT(REG_DPU_RDMA_RDMA_BN_BASE_ADDR, 0x0);
EMIT(REG_DPU_RDMA_RDMA_ERDMA_CFG, DPU_RDMA_RDMA_ERDMA_CFG_ERDMA_DISABLE(1));
EMIT(REG_DPU_RDMA_RDMA_EW_BASE_ADDR, 0x0);
EMIT(REG_DPU_RDMA_RDMA_EW_SURF_STRIDE, 0x0);
EMIT(REG_DPU_RDMA_RDMA_FEATURE_MODE_CFG, DPU_RDMA_RDMA_FEATURE_MODE_CFG_BURST_LEN(15) | DPU_RDMA_RDMA_FEATURE_MODE_CFG_FLYING_MODE(1));
EMIT(REG_DPU_RDMA_RDMA_SRC_DMA_CFG, 0x0);
EMIT(REG_DPU_RDMA_RDMA_SURF_NOTCH, 0x0);
EMIT(REG_DPU_RDMA_RDMA_PAD_CFG, 0x0);
...
EMIT(REG_PC_BASE_ADDRESS, PC_BASE_ADDRESS_PC_SOURCE_ADDR(268431924));
EMIT(REG_PC_REGISTER_AMOUNTS, PC_REGISTER_AMOUNTS_PC_DATA_AMOUNT(36));
WARNING: target 0x41 doesn't match register's domain 0x100
EMIT(REG_PC_VERSION, 0x0);
WARNING: target 0x81 doesn't match register's domain 0x100
...
EMIT(REG_DPU_DATA_FORMAT, 0x0);
EMIT(REG_DPU_OFFSET_PEND, 0x0);
EMIT(REG_DPU_DST_BASE_ADDR, 0xffff1080);
EMIT(REG_DPU_DST_SURF_STRIDE, DPU_DST_SURF_STRIDE_DST_SURF_STRIDE(4));
EMIT(REG_DPU_DATA_CUBE_WIDTH, DPU_DATA_CUBE_WIDTH_WIDTH(1));
EMIT(REG_DPU_DATA_CUBE_HEIGHT, DPU_DATA_CUBE_HEIGHT_HEIGHT(1));
EMIT(REG_DPU_DATA_CUBE_NOTCH_ADDR, 0x0);
...
EMIT(REG_DPU_RDMA_RDMA_DATA_CUBE_HEIGHT, DPU_RDMA_RDMA_DATA_CUBE_HEIGHT_HEIGHT(1));
EMIT(REG_DPU_RDMA_RDMA_DATA_CUBE_CHANNEL, DPU_RDMA_RDMA_DATA_CUBE_CHANNEL_CHANNEL(15));
EMIT(REG_DPU_RDMA_RDMA_SRC_BASE_ADDR, 0xffff1040);
EMIT(REG_DPU_RDMA_RDMA_BRDMA_CFG, 0x0);
EMIT(REG_DPU_RDMA_RDMA_BS_BASE_ADDR, 0x0);
EMIT(REG_DPU_RDMA_RDMA_NRDMA_CFG, 0x0);
EMIT(REG_DPU_RDMA_RDMA_BN_BASE_ADDR, 0x0);
...
EMIT(REG_DPU_RDMA_RDMA_WEIGHT, DPU_RDMA_RDMA_WEIGHT_E_WEIGHT(1) | DPU_RDMA_RDMA_WEIGHT_N_WEIGHT(1) | DPU_RDMA_RDMA_WEIGHT_B_WEIGHT(1) | DPU_RDMA_RDMA_WEIGHT_M_WEIGHT(1));
EMIT(REG_DPU_RDMA_RDMA_EW_SURF_NOTCH, 0x0);
EMIT(REG_PC_BASE_ADDRESS, PC_BASE_ADDRESS_PC_SOURCE_ADDR(268431964));
EMIT(REG_PC_REGISTER_AMOUNTS, PC_REGISTER_AMOUNTS_PC_DATA_AMOUNT(36));
WARNING: target 0x41 doesn't match register's domain 0x100
EMIT(REG_PC_VERSION, 0x0);
WARNING: target 0x81 doesn't match register's domain 0x100
...
EMIT(REG_DPU_DATA_FORMAT, 0x0);
EMIT(REG_DPU_OFFSET_PEND, 0x0);
EMIT(REG_DPU_DST_BASE_ADDR, 0xffff1040);
EMIT(REG_DPU_DST_SURF_STRIDE, DPU_DST_SURF_STRIDE_DST_SURF_STRIDE(4));
EMIT(REG_DPU_DATA_CUBE_WIDTH, DPU_DATA_CUBE_WIDTH_WIDTH(1));
EMIT(REG_DPU_DATA_CUBE_HEIGHT, DPU_DATA_CUBE_HEIGHT_HEIGHT(1));
EMIT(REG_DPU_DATA_CUBE_NOTCH_ADDR, 0x0);
...
EMIT(REG_DPU_RDMA_RDMA_DATA_CUBE_HEIGHT, DPU_RDMA_RDMA_DATA_CUBE_HEIGHT_HEIGHT(1));
EMIT(REG_DPU_RDMA_RDMA_DATA_CUBE_CHANNEL, DPU_RDMA_RDMA_DATA_CUBE_CHANNEL_CHANNEL(15));
EMIT(REG_DPU_RDMA_RDMA_SRC_BASE_ADDR, 0xffff1100);
EMIT(REG_DPU_RDMA_RDMA_BRDMA_CFG, 0x0);
EMIT(REG_DPU_RDMA_RDMA_BS_BASE_ADDR, 0x0);
EMIT(REG_DPU_RDMA_RDMA_NRDMA_CFG, 0x0);
EMIT(REG_DPU_RDMA_RDMA_BN_BASE_ADDR, 0x0);
...
WARNING: target 0x0 doesn't match register's domain 0x100
EMIT(REG_PC_VERSION, 0x0);
EMIT(REG_PC_REGISTER_AMOUNTS, 0x0);
WARNING: target 0x41 doesn't match register's domain 0x100
EMIT(REG_PC_VERSION, 0x0);
WARNING: target 0x81 doesn't match register's domain 0x100
EMIT(REG_PC_OPERATION_ENABLE, PC_OPERATION_ENABLE_RESERVED_0(12));
...
EMIT(REG_PC_VERSION, 0x0);
WARNING: target 0x0 doesn't match register's domain 0x100
EMIT(REG_PC_VERSION, 0x40000);
0 18 3000000
0 -1 1
0 45 0
0 280 0
WARNING: target 0x0 doesn't match register's domain 0x100
EMIT(REG_PC_VERSION, 0x80000);
0 18 3000000
0 -1 1
0 45 0
0 500 0
