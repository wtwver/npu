...
# Preserve GEM2 register programming only through the first PC_OPERATION_ENABLE (offset 0xbf8).
shell python3 patch_task_buffer.py --mode regs --reg-flink 2 --reg-offset 0xc00
