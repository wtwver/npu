...
# shell python3 patch_task_buffer.py --mode regs --reg-flink 2 --reg-offset 0xdc0
shell python3 patch_task_buffer.py --mode regs --reg-flink 2 --reg-offset 0x240 --reg-end 0xa40
shell python3 patch_task_buffer.py --mode regs --reg-flink 2 --reg-offset 0xdc0 
