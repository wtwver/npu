...
def main():
    ...
    print(f"Expected output: {torch.sigmoid(x)}")
    ...
    torch.onnx.export(
        ...
        input_names=["input_x"],
        output_names=["output"],
        # Keep opset 15 for consistency with other generators
        opset_version=15,
    ...
    rknn = RKNN()
    # Match silu generator settings; disable conv_eltwise_activation_fuse to keep activation explicit.
    rknn.config(
