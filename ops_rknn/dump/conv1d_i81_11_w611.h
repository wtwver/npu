...
EMIT(REG_CNA_FEATURE_DATA_ADDR, 0xffe87000);
...
EMIT(REG_CNA_DCOMP_CTRL, 0x00000000);
EMIT(REG_CNA_DCOMP_REGNUM, 0x00000000);
EMIT(REG_CNA_DCOMP_ADDR0, 0xff940000);
...
[0xff940a48] lsb 0801000000003030 - CORE Unknown
...
EMIT(REG_DPU_DST_BASE_ADDR, 0xffb67000);
...
[0xff940b78] lsb 10010000000040c4 - DPU Unknown
...
EMIT(REG_PC_BASE_ADDRESS, PC_BASE_ADDRESS_PC_SOURCE_ADDR(267993280));
...
EMIT(REG_CNA_FC_CON1, 0x00000000);
EMIT(REG_CNA_PAD_CON0, 0x00000000);
EMIT(REG_CNA_FEATURE_DATA_ADDR, 0xffe87020);
EMIT(REG_CNA_FC_CON2, 0x00000000);
EMIT(REG_CNA_DMA_CON0, CNA_DMA_CON0_WEIGHT_BURST_LEN(15) | CNA_DMA_CON0_DATA_BURST_LEN(15));
EMIT(REG_CNA_DMA_CON1, CNA_DMA_CON1_LINE_STRIDE(16));
EMIT(REG_CNA_DMA_CON2, 0x00000000);
...
EMIT(REG_CORE_DATAOUT_SIZE_1, CORE_DATAOUT_SIZE_1_DATAOUT_CHANNEL(15));
EMIT(REG_CORE_CLIP_TRUNCATE, 0x00000000);
[0xff940dc8] lsb 0801000000003030 - CORE Unknown
EMIT(REG_DPU_FEATURE_MODE_CFG, DPU_FEATURE_MODE_CFG_BURST_LEN(15) | DPU_FEATURE_MODE_CFG_OUTPUT_MODE(2));
EMIT(REG_DPU_DATA_FORMAT, DPU_DATA_FORMAT_OUT_PRECISION(2) | DPU_DATA_FORMAT_IN_PRECISION(2) | DPU_DATA_FORMAT_PROC_PRECISION(2));
EMIT(REG_DPU_OFFSET_PEND, 0x00000000);
EMIT(REG_DPU_DST_BASE_ADDR, 0xffb670c0);
EMIT(REG_DPU_DST_SURF_STRIDE, DPU_DST_SURF_STRIDE_DST_SURF_STRIDE(12));
EMIT(REG_DPU_DATA_CUBE_WIDTH, DPU_DATA_CUBE_WIDTH_WIDTH(10));
EMIT(REG_DPU_DATA_CUBE_HEIGHT, 0x00000000);
EMIT(REG_DPU_DATA_CUBE_NOTCH_ADDR, 0x00000000);
...
EMIT(REG_DPU_EW_OP_VALUE_7, 0x00000000);
EMIT(REG_DPU_SURFACE_ADD, DPU_SURFACE_ADD_SURF_ADD(24));
[0xff940ef8] lsb 10010000000040c4 - DPU Unknown
EMIT(REG_DPU_LUT_ACCESS_CFG, 0x00000000);
EMIT(REG_DPU_LUT_ACCESS_DATA, 0x00000000);
EMIT(REG_DPU_LUT_CFG, 0x00000000);
EMIT(REG_DPU_LUT_INFO, 0x00000000);
...
EMIT(REG_DPU_LUT_LO_SLOPE_SCALE, 0x00000000);
EMIT(REG_DPU_LUT_LO_SLOPE_SHIFT, 0x00000000);
EMIT(REG_PC_BASE_ADDRESS, PC_BASE_ADDRESS_PC_SOURCE_ADDR(267993336));
EMIT(REG_PC_REGISTER_AMOUNTS, PC_REGISTER_AMOUNTS_PC_DATA_AMOUNT(29));
EMIT(REG_PC_VERSION, 0x00000000);
EMIT(REG_PC_OPERATION_ENABLE, PC_OPERATION_ENABLE_RESERVED_0(6) | PC_OPERATION_ENABLE_OP_EN(1));
EMIT(REG_CNA_CBUF_CON0, CNA_CBUF_CON0_WEIGHT_BANK(11) | CNA_CBUF_CON0_DATA_BANK(1));
EMIT(REG_CNA_DCOMP_REGNUM, 0x00000000);
...
EMIT(REG_CNA_FC_CON1, 0x00000000);
EMIT(REG_CNA_PAD_CON0, 0x00000000);
EMIT(REG_CNA_FEATURE_DATA_ADDR, 0xffe87040);
EMIT(REG_CNA_FC_CON2, 0x00000000);
EMIT(REG_CNA_DMA_CON0, CNA_DMA_CON0_WEIGHT_BURST_LEN(15) | CNA_DMA_CON0_DATA_BURST_LEN(15));
EMIT(REG_CNA_DMA_CON1, CNA_DMA_CON1_LINE_STRIDE(16));
EMIT(REG_CNA_DMA_CON2, 0x00000000);
...
EMIT(REG_CNA_CVT_CON5, 0x0000ffff);
EMIT(REG_CNA_PAD_CON1, 0x00000000);
EMIT(REG_DPU_DST_BASE_ADDR, 0xffb67180);
EMIT(REG_DPU_WDMA_SIZE_0, DPU_WDMA_SIZE_0_CHANNEL_WDMA(15));
EMIT(REG_DPU_WDMA_SIZE_1, DPU_WDMA_SIZE_1_WIDTH_WDMA(10));
EMIT(REG_PC_BASE_ADDRESS, PC_BASE_ADDRESS_PC_SOURCE_ADDR(267993368));
EMIT(REG_PC_REGISTER_AMOUNTS, PC_REGISTER_AMOUNTS_PC_DATA_AMOUNT(29));
EMIT(REG_PC_VERSION, 0x00000000);
EMIT(REG_PC_OPERATION_ENABLE, PC_OPERATION_ENABLE_RESERVED_0(6) | PC_OPERATION_ENABLE_OP_EN(1));
EMIT(REG_CNA_CBUF_CON0, CNA_CBUF_CON0_WEIGHT_BANK(11) | CNA_CBUF_CON0_DATA_BANK(1));
...
EMIT(REG_CNA_FC_CON1, 0x00000000);
EMIT(REG_CNA_PAD_CON0, 0x00000000);
EMIT(REG_CNA_FEATURE_DATA_ADDR, 0xffe87060);
EMIT(REG_CNA_FC_CON2, 0x00000000);
EMIT(REG_CNA_DMA_CON0, CNA_DMA_CON0_WEIGHT_BURST_LEN(15) | CNA_DMA_CON0_DATA_BURST_LEN(15));
EMIT(REG_CNA_DMA_CON1, CNA_DMA_CON1_LINE_STRIDE(16));
EMIT(REG_CNA_DMA_CON2, 0x00000000);
...
EMIT(REG_CNA_CVT_CON5, 0x0000ffff);
EMIT(REG_CNA_PAD_CON1, 0x00000000);
EMIT(REG_DPU_DST_BASE_ADDR, 0xffb67240);
EMIT(REG_DPU_WDMA_SIZE_0, DPU_WDMA_SIZE_0_CHANNEL_WDMA(15));
EMIT(REG_DPU_WDMA_SIZE_1, DPU_WDMA_SIZE_1_WIDTH_WDMA(10));
EMIT(REG_PC_BASE_ADDRESS, PC_BASE_ADDRESS_PC_SOURCE_ADDR(267993400));
EMIT(REG_PC_REGISTER_AMOUNTS, PC_REGISTER_AMOUNTS_PC_DATA_AMOUNT(29));
EMIT(REG_PC_VERSION, 0x00000000);
EMIT(REG_PC_OPERATION_ENABLE, PC_OPERATION_ENABLE_RESERVED_0(6) | PC_OPERATION_ENABLE_OP_EN(1));
EMIT(REG_CNA_CBUF_CON0, CNA_CBUF_CON0_WEIGHT_BANK(11) | CNA_CBUF_CON0_DATA_BANK(1));
...
EMIT(REG_CNA_FC_CON1, 0x00000000);
EMIT(REG_CNA_PAD_CON0, 0x00000000);
EMIT(REG_CNA_FEATURE_DATA_ADDR, 0xffe87080);
EMIT(REG_CNA_FC_CON2, 0x00000000);
EMIT(REG_CNA_DMA_CON0, CNA_DMA_CON0_WEIGHT_BURST_LEN(15) | CNA_DMA_CON0_DATA_BURST_LEN(15));
EMIT(REG_CNA_DMA_CON1, CNA_DMA_CON1_LINE_STRIDE(16));
EMIT(REG_CNA_DMA_CON2, 0x00000000);
...
EMIT(REG_CNA_CVT_CON5, 0x0000ffff);
EMIT(REG_CNA_PAD_CON1, 0x00000000);
EMIT(REG_DPU_DST_BASE_ADDR, 0xffb67300);
EMIT(REG_DPU_WDMA_SIZE_0, DPU_WDMA_SIZE_0_CHANNEL_WDMA(15));
EMIT(REG_DPU_WDMA_SIZE_1, DPU_WDMA_SIZE_1_WIDTH_WDMA(10));
EMIT(REG_PC_BASE_ADDRESS, PC_BASE_ADDRESS_PC_SOURCE_ADDR(267993432));
EMIT(REG_PC_REGISTER_AMOUNTS, PC_REGISTER_AMOUNTS_PC_DATA_AMOUNT(29));
EMIT(REG_PC_VERSION, 0x00000000);
EMIT(REG_PC_OPERATION_ENABLE, PC_OPERATION_ENABLE_RESERVED_0(6) | PC_OPERATION_ENABLE_OP_EN(1));
EMIT(REG_CNA_CBUF_CON0, CNA_CBUF_CON0_WEIGHT_BANK(11) | CNA_CBUF_CON0_DATA_BANK(1));
...
EMIT(REG_CNA_FC_CON1, 0x00000000);
EMIT(REG_CNA_PAD_CON0, 0x00000000);
EMIT(REG_CNA_FEATURE_DATA_ADDR, 0xffe870a0);
EMIT(REG_CNA_FC_CON2, 0x00000000);
EMIT(REG_CNA_DMA_CON0, CNA_DMA_CON0_WEIGHT_BURST_LEN(15) | CNA_DMA_CON0_DATA_BURST_LEN(15));
EMIT(REG_CNA_DMA_CON1, CNA_DMA_CON1_LINE_STRIDE(16));
EMIT(REG_CNA_DMA_CON2, 0x00000000);
...
EMIT(REG_CNA_CVT_CON5, 0x0000ffff);
EMIT(REG_CNA_PAD_CON1, 0x00000000);
EMIT(REG_DPU_DST_BASE_ADDR, 0xffb673c0);
EMIT(REG_DPU_WDMA_SIZE_0, DPU_WDMA_SIZE_0_CHANNEL_WDMA(15));
EMIT(REG_DPU_WDMA_SIZE_1, DPU_WDMA_SIZE_1_WIDTH_WDMA(10));
EMIT(REG_PC_BASE_ADDRESS, PC_BASE_ADDRESS_PC_SOURCE_ADDR(267993464));
EMIT(REG_PC_REGISTER_AMOUNTS, PC_REGISTER_AMOUNTS_PC_DATA_AMOUNT(29));
EMIT(REG_PC_VERSION, 0x00000000);
EMIT(REG_PC_OPERATION_ENABLE, PC_OPERATION_ENABLE_RESERVED_0(6) | PC_OPERATION_ENABLE_OP_EN(1));
EMIT(REG_CNA_CBUF_CON0, CNA_CBUF_CON0_WEIGHT_BANK(11) | CNA_CBUF_CON0_DATA_BANK(1));
...
EMIT(REG_CNA_FC_CON1, 0x00000000);
EMIT(REG_CNA_PAD_CON0, 0x00000000);
EMIT(REG_CNA_FEATURE_DATA_ADDR, 0xffe870c0);
EMIT(REG_CNA_FC_CON2, 0x00000000);
EMIT(REG_CNA_DMA_CON0, CNA_DMA_CON0_WEIGHT_BURST_LEN(15) | CNA_DMA_CON0_DATA_BURST_LEN(15));
EMIT(REG_CNA_DMA_CON1, CNA_DMA_CON1_LINE_STRIDE(16));
EMIT(REG_CNA_DMA_CON2, 0x00000000);
...
EMIT(REG_CNA_CVT_CON5, 0x0000ffff);
EMIT(REG_CNA_PAD_CON1, 0x00000000);
EMIT(REG_DPU_DST_BASE_ADDR, 0xffb67480);
EMIT(REG_DPU_WDMA_SIZE_0, DPU_WDMA_SIZE_0_CHANNEL_WDMA(15));
EMIT(REG_DPU_WDMA_SIZE_1, DPU_WDMA_SIZE_1_WIDTH_WDMA(10));
EMIT(REG_PC_BASE_ADDRESS, PC_BASE_ADDRESS_PC_SOURCE_ADDR(267993496));
EMIT(REG_PC_REGISTER_AMOUNTS, PC_REGISTER_AMOUNTS_PC_DATA_AMOUNT(29));
EMIT(REG_PC_VERSION, 0x00000000);
EMIT(REG_PC_OPERATION_ENABLE, PC_OPERATION_ENABLE_RESERVED_0(6) | PC_OPERATION_ENABLE_OP_EN(1));
EMIT(REG_CNA_CBUF_CON0, CNA_CBUF_CON0_WEIGHT_BANK(11) | CNA_CBUF_CON0_DATA_BANK(1));
...
EMIT(REG_CNA_FC_CON1, 0x00000000);
EMIT(REG_CNA_PAD_CON0, 0x00000000);
EMIT(REG_CNA_FEATURE_DATA_ADDR, 0xffe870e0);
EMIT(REG_CNA_FC_CON2, 0x00000000);
EMIT(REG_CNA_DMA_CON0, CNA_DMA_CON0_WEIGHT_BURST_LEN(15) | CNA_DMA_CON0_DATA_BURST_LEN(15));
EMIT(REG_CNA_DMA_CON1, CNA_DMA_CON1_LINE_STRIDE(16));
EMIT(REG_CNA_DMA_CON2, 0x00000000);
...
EMIT(REG_CNA_CVT_CON5, 0x0000ffff);
EMIT(REG_CNA_PAD_CON1, 0x00000000);
EMIT(REG_DPU_DST_BASE_ADDR, 0xffb67540);
EMIT(REG_DPU_WDMA_SIZE_0, DPU_WDMA_SIZE_0_CHANNEL_WDMA(15));
EMIT(REG_DPU_WDMA_SIZE_1, DPU_WDMA_SIZE_1_WIDTH_WDMA(10));
